      ...
      <main>
        <section className="flex justify-around mt-8 first">
          <div className="leftSection w-[30%] text-4xl mt-20 text-black">
            ...
            <span id="element" className="text-[#3FDA49]">What can we do for you?</span>
          </div>
          <div className="rightSection w-[30%]">
            <Image src={leftImage} alt="developer image" className="h-[55vh] w-[90%] mt-4 filter drop-shadow-[5px_5px_20px_rgba(130,232,48,0.797)]" />
          </div>
        </section>

        <hr className="border-0 bg-[#7528E1] h-[0.07em] mx-[5em] mt-[5em]" />

        <section className="second max-w-[80vw] mx-auto mt-4 flex justify-around mb-12">
          <div className="w-[30%] h-[10em] bg-[#D7C144]/80 text-[#070736] rounded-lg"></div>
          <div className="w-[30%] h-[10em] bg-[#D7C144]/80 text-[#070736] rounded-lg"></div>
          <div className="w-[30%] h-[10em] bg-[#D7C144]/80 text-[#070736] rounded-lg"></div>
        </section>
        ...
        <footer className="mt-80 bg-gradient-to-r from-[#070736] to-[#08084E]">
          ...
          <div className="mt-12 text-center text-black copyright">
            <div className="flex items-center justify-center gap-8 pages">
              <a href="/terms" className="text-black">Conditions of Use</a>
              <a href="/privacy" className="text-black">Privacy Notice</a>
              <a href="/ads-choices" className="text-black">Your Ads Privacy Choices</a>
            </div>
            <div className="pb-4 mt-1 copyright-tag">© 1996-2024, budgetbliss.com, Inc. or its affiliates</div>
          </div>
        </footer>
      </main>
    </>
